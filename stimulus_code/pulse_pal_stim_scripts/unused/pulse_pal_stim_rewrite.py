...
# set up stims
stims = {1: dict(n=1, dur=1.0, f=10),
         2: dict(n=3, dur=1.0, f=10),
         3: dict(n=5, dur=1.0, f=10),
         4: dict(n=1, dur=5.0, f=50),
         5: dict(n=3, dur=5.0, f=50),
         6: dict(n=5, dur=5.0, f=50),
         7: dict(n=1, dur=1.0, f=50),
         8: dict(n=3, dur=1.0, f=50),
         9: dict(n=5, dur=1.0, f=50)}
